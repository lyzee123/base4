...
/*
func (client *Nc) GetProfilePictureInfo(jid types.JID, param any) (string, error) {
resp, err := client.GetProfilePictureInfo(jid, param) //&waSocket.GetProfilePictureParams{Preview: false, ExistingID: "", IsCommunity: false})
  if err == nil {
      return resp, nil
  } else {
      return "https://ik.imagekit.io/lui/2023-12-16_17_11_11__0000_UTC", nil
  }
  }
  */
